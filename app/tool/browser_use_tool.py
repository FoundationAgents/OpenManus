...
class BrowserUseTool(BaseTool, Generic[Context]):
    ...
    parameters: dict = {
        ...
        "properties": {
            ...
            "index": {
                "type": "integer",
                "description": "Element index for 'click_element', 'input_text', "
            ...
            "scroll_amount": {
                "type": "integer",
                "description": "Pixels to scroll (positive for down, negative for up) for 'scroll_down'"
                "or 'scroll_up' actions",
            },
            "tab_id": {
                "type": "integer",
